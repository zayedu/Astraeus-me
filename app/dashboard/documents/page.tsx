...
import { Download, FileText, MoreHorizontal, Pencil, Search, LoaderCircle, ArrowLeft } from "lucide-react"
...
export default function DocumentsPage() {
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-blue-50">
      <div className="p-8 animate-fade-in h-full flex flex-col">
        <header className="mb-8 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-white via-blue-100 to-blue-200 bg-clip-text text-transparent mb-1 tracking-tight">
              PAR Documents
            </h1>
              ...
              {filteredDocuments.map((doc, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs text-blue-200/60 mt-auto pt-4 border-t border-white/10">
                    <span
                      className={cn("px-2.5 py-1 font-medium rounded-md border text-xs", getStatusClass(doc.status))}
                    >
                      {doc.status}
                    </span>
